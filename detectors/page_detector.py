    ...
    *,
    ...
    return PageDetectionResult(
        ...
        stats={
            ...
            "raw_comic_text_blocks": getattr(active_text_detector, "last_raw_comic_text_blocks", len(comic_text_regions)),
            "raw_comic_line_regions": getattr(active_text_detector, "last_raw_comic_line_regions", 0),
            "comic_grouped_from_lines": getattr(active_text_detector, "last_comic_grouped_from_lines", 0),
